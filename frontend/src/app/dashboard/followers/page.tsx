...
export default function FollowersPage() {
  ...
  const fetchFollowers = async () => {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/follow/${decoded.id}/followers`, {
  ...
  if (loading) {
    return <div className="text-center mt-10 text-gray-600">Loading followers...</div>;
  }

  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">Your Followers</h1>
